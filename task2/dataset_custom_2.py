...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        train_img = crop_by_index(np.array(Image.open(os.path.join(self.train_dir, self.images[idx])).convert('L')),self.crop_ind)
        target_img = crop_by_index(np.array(Image.open(os.path.join(self.target_dir, self.images[idx])).convert('L')),self.crop_ind)
